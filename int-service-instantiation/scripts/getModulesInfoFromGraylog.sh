...
curl -X GET http://172.20.49.181:12900/search/universal/keyword/export?query=container_name%3Ason-gtkapi%20AND%20message%3A*POST*&keyword=last%205%20minutes&fields=message >> LOGMESSAGE
